                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_assoc($hasil)):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn bg-success text-white mb-0"
                                                        href="pages/edit-menu.php?id=<?= $id ?>">
                                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    </a>
                                                    <a class="btn bg-danger text-white mb-0" href="">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="POST">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input type="submit" name="tambahPelanggan" class="btn bg-info text-white" value="Simpan">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
